    ...
    <div className="space-y-6">
        ...
        {campaigns.map((c) => (
          <div key={String(c.id)} className={`${CARD} p-5`}>
            ...
            <div className="mt-4 flex gap-2">
              <button onClick={() => openEdit(c)} className="flex flex-1 items-center justify-center gap-1 rounded-xl border border-[#e9dfc9] px-3 py-2 text-xs font-semibold text-gray-600 hover:bg-[#faf6ec]"><Edit3 className="h-3 w-3" />Edit</button>
      ...
      <div>
        <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
          ...
          <button onClick={() => setAchieverModalOpen(true)} className="flex items-center gap-2 rounded-xl border border-[#e9dfc9] bg-white px-3 py-2 text-xs font-semibold text-gray-600 hover:bg-[#faf6ec]"><UserPlus className="h-3.5 w-3.5" />Add Achievers</button>
        </div>
        <div className={CARD}>
