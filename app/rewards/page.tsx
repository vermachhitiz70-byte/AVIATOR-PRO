...
export default function Rewards() {
  return (
    <div>
      <SiteHeader />
      <PageHero kicker="Rewards" titleA="20 vaults." titleB="Up to $500,000." accent="gold" sub="Grow self + direct + team business to crack each vault. Rewards land straight in your withdrawable Reward wallet — plus lifetime commissions on two tracks." cta1={{ label: "Unlock Vaults", href: "/register" }} cta2={{ label: "Track Progress", href: "/dash/business-plan" }} />
