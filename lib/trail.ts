...
// Shared money-trail builder (admin Money Trail + user History page).
// Full chronological story: deposits, bots, every income (with WHO paid),
...
export async function buildTrail(userId: string, db: Client = getDb()) {
